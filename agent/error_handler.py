...
ERROR_ANALYST_PROMPT = """You are the error recovery module of OCTO AI assistant.
...
Attempt number: {attempt}"""
    ...
    try:
        text = text_llm.ask(prompt, system=ERROR_ANALYST_PROMPT).strip()
...
Return ONLY the Python code, no explanation."""
    ...
    try:
        code = text_llm.ask(prompt).strip()
